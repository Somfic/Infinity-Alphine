 ...
 * the different types of alphine.components this family must contain in order to accept
 * an entity as member.
 * </p>
 * <p>
...
public class EntityFilter {
     ...
     * 
     * @param types
     *            the types of alphine.components an entity must contain in order to be
