...
public final class Entity {
    ...
    /** The list of alphine.components this entity is composed of. */
    private List<Component> components = new ArrayList<>();
    
    /** Provides fast access to alphine.components based on its type. */
    ...
    /**
     * Retrieves a list of all alphine.components of the specified type.
     * 
     * <p>
     ...
     *            this method
     * @param clazz
     *            the class or interface the requested alphine.components must implement
     * @return a list with alphine.components of the specified type (may be empty)
     */
     ...
     * has been added to. Activating an entity will activate its alphine.components in
     * exactly the order its alphine.components have been added.
     */
    void activate() {
        if (isActivated()) {
    ...
    void deactivate() {
        ...
        // deactivate alphine.components in reverse order
